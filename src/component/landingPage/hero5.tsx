...
export default function Hero5() {
    return <section className="w-dvw relative  min-h-[dvh] flex justify-start items-center pb-16 flex-col bg-white">
        <h3 className="text-[24px] mb-10 md:text-[28px] lg:text-[32px] xl:text-[36px] font-bold">Our <span className="relative"><img src={textDesign.src} className="absolute -bottom-1 left-0 w-full" alt="i&s" />Clients</span></h3>
        <div className="w-full flex overflow-hidden ">
            <div className="flex w-full flex-shrink-0 infinite-scroll">
