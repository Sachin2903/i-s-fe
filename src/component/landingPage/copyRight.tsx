...
export default function CopyRight() {
    return <section className="py-3 flex justify-between items-center text-[15px] md:text-[16px] lg:text-[17px] xl:text-[18px] text-[#7F848D]  sm:py-4  gap-1  w-full bg-[#000B1D] px-[2%] lg:px-[3%] xl:px-[4%]">
        ...
        <aside className="flex justify-center items-center gap-3 ">
            {/* <Link href="/" target="_blank"><FaInstagram className="scale-125" /></Link> */}
            <Link href="https://www.linkedin.com/company/instruments-systems" target="_blank"><FaLinkedin className="scale-125" /></Link>
            <Link href="https://www.facebook.com/InstrumentsSystems" target="_blank"><FiFacebook className="scale-125" /></Link>
            {/* <Link href="/" target="_blank"><RiYoutubeLine className="scale-125" /></Link> */}
        </aside>
    </section>
}