...
export default function Navbar() {
    return <nav className="flex justify-between items-center bg-black/30  z-20 backdrop-blur-3xl px-[3%] lg:px-[4%] xl:px-[5%] pt-5 sm:pt-8 xl:pt-9 pb-2 sm:pb-4 w-full ">
