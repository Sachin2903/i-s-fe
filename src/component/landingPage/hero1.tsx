    ...
    return (
        <section className="relative w-full h-screen">
            ...
            <section className="flex px-[3%] lg:px-[4%] xl:px-[5%] flex-col justify-evenly items-center w-full h-full ">
                <aside className="text-[50px] relative z-10 sm:text-[55px] text-shadow-lg flex justify-start flex-col items-center lg:items-start md:text-[65px]  leading-14 sm:leading-20 xl:leading-24 lg:text-[75px] xl:text-[96px]   w-full text-white  font-bold">
                    <p>Welcome to</p>
