        ...
        <section className="relative w-full h-screen">
            ...
            <section className="flex px-[3%] lg:px-[4%] xl:px-[5%] flex-col justify-evenly items-center w-full h-full ">
                ...
                <aside className="flex w-full relative z-10 justify-center  lg:justify-start items-center flex-wrap    gap-5 sm:gap-8">
                    <Link href="/products" className="px-10 sm:px-12 md:px-14 lg:px-16 xl:px-20 rounded-xl flex-shrink-0 font-semibold text-base md:text-lg py-4 md:py-4 lg:py-5 xl:py-6 text-[#0057FF] bg-white">Learn More</Link>
                    <Link href="/contactus" className="px-10 sm:px-12 md:px-14 lg:px-16 xl:px-20 rounded-xl flex-shrink-0 font-semibold text-base md:text-lg py-4 md:py-4 lg:py-5 xl:py-6 text-white bg-[#0057FF]">Online Enquiry</Link>
                </aside>
            </section>
