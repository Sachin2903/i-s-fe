...
export default function Hero1() {
    return <section className="w-full flex justify-start flex-col items-center   h-full">
        ...
        <section className="flex px-[3%] lg:px-[4%] xl:px-[5%] flex-col justify-evenly items-center w-full h-full ">
            <aside className="text-[50px]  sm:text-[55px] text-shadow-lg flex justify-start flex-col items-center lg:items-start md:text-[65px]  leading-14 sm:leading-20 xl:leading-24 lg:text-[75px] xl:text-[96px]   w-full text-white relative z-30 font-bold">
                <p>Welcome to</p>
            ...
            <aside className="flex w-full justify-center  lg:justify-start items-center flex-wrap  relative z-30  gap-5 sm:gap-8">
